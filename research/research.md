...
SeeClickFix: ~35% критичних відгуків — не про UX, а про те що влада закриває тикети без дії. Прізвисько "See Click Ignore" — народне. FixMyStreet: деякі ради відписують *"don't use this app"* після подачі звіту. Для District Care: потрібен чіткий публічний реєстр партнерів до запуску — або переосмислений фреймінг ("ти зафіксував і передав далі", а не "ти подав і чекаєш виправлення").
